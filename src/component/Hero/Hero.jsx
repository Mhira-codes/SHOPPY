  ...
  return (
    <div className="hero-section">
      ...
      <div className="middle-side flex items-baseline justify-center relative">
        ...
        className="blue-img w-[30rem] h-[30rem] absolute -z-[99] rounded-full bottom-0"></motion.div>
        <motion.img 
        initial={{bottom:"-2rem"}}
        whileInView={{bottom:"0rem"}}
        transition={transition}
        src={heroImg} alt="" width={600} className="w-[30rem] absolute bottom-0" />
        <motion.div 
        initial={{right:'2%'}}
        whileInView={{right:'4%'}}
        transition={transition}
        className="cart absolute bottom-[23%] right-[4%] flex gap-[1rem]">
            <div>
